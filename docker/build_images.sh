...
docker build -t semweb/caphub_nginx:v1.0.9 -t semweb/caphub_nginx:v1.0 -t semweb/caphub_nginx:v1 -t semweb/caphub_nginx:latest .
docker push semweb/caphub_nginx:v1.0.9
